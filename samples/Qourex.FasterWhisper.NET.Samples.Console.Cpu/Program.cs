...
namespace Qourex.FasterWhisper.NET.Samples.Console.Cpu
{
    class Program
    {
        static async Task Main(string[] args)
        {
            System.Console.WriteLine("=== FasterWhisper.NET CPU Console Sample ===");
            ...
            // 2. Build the Model
            System.Console.WriteLine("Loading model on CPU...");
